...
export default function Map(): JSX.Element {
    ...
    (async () => {
      ...
      try {
        const res = await axios.post(
          ...
          { status: "RUNNING", startDate: todayISO, endDate: todayISO, todayDate: todayISO },
          {
            headers: {
        ...
        const path: LatLng[] = Array.isArray(res.data?.recentPath) ? res.data.recentPath : [];
  ...
  if (Platform.OS === "android") {
    return (
      <View className="justify-center items-center bg-[#101010]" style={{ flex: 1 }}>
        <GoogleMapsWebView
          style={mapStyle}
